        ...
        <div class="branding docs-branding">
            <div class="container-fluid position-relative py-2">
                ...
                <button id="docs-sidebar-toggler" class="docs-sidebar-toggler docs-sidebar-visible me-2 d-xl-none" type="button">
	                ...
	                <div class="site-logo"><a class="navbar-brand" href="{{url('/')}}"><img class="logo-icon me-2" src="{{url('assets/images/coderdocs-logo.svg')}}" alt="logo"><span class="logo-text">Enable<span class="text-alt">CORS</span></span></a></div>    
	            ...
	            <div class="docs-top-utilities d-flex justify-content-end align-items-center">
                    ...
                    <!--//social-list-->
		            <a href="https://github.com/alaksandarjesus/enablecors"  target="_blank" class="btn btn-primary d-none d-lg-flex">Download</a>
